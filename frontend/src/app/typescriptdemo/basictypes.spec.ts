describe('Declaring Variables in TypeScript', () => {
  describe('Explicity Typed Variables', () => {
    it('defining types', () => {
      ...
      //at this stage myName will have avaiable the intersecting behaviour of both string and numbers
      //once a type is defined, then the behviour of that type will be only available
